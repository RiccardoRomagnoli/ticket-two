        ...
        <div class="uk-modal-dialog uk-flex uk-flex-center uk-flex-middle" uk-height-viewport>
            ...
            <form id="addBigliettoForm" class ="uk-width-1-1 uk-width-1-3@m uk-margin-left uk-margin-right">
                <fieldset class="uk-fieldset">
                    ...
                    <div class="uk-margin">
                        <label class="uk-form-label" for="addSelectIdSezioneEvento">Sezione del Biglietto</label></br>
                    ...
                    <div class="uk-margin">
                        <label class="uk-form-label" for="addSelectIdTipoBiglietto">Tipologia Biglietto</label></br>
                        <select style="width: 50%" class="selectTipoBiglietto" id="addSelectIdTipoBiglietto">
                        </select>
                    </div>

                    <div class="uk-margin">
                        <label class="uk-form-label" for="addDataInizioBiglietto">Data inizio evento</label>
                    ...
                    <div class="uk-margin">
                        <label class="uk-form-label" for="addDataFineBiglietto">Data fine evento</label>
                    ...
                    <div class="uk-margin">
                        <label class="uk-form-label" for="addOrarioBiglietto">Orario</label>
                    ...
                    <div class="uk-margin">
                        <label class="uk-form-label" for="addPrezzoBiglietto">Prezzo</label>
